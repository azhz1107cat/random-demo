...
- 纯前端开发,您可以直接下载到您设备脱机上使用
- 更加安全的抽签机制
- 多种抽签模式可以选择
- 抽签过程有动画，多种！可在设置自行选择( 正在做，先画个饼 )
- 将抽签结果导出为txt, json, xlsx
...
文件地址 :  [https://github.io/azhz1107cat/random-demo](https://github.io/azhz1107cat/random-demo)
